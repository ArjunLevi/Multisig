 ...
 */
function makeMultisignedTx(multisigPubkey, sequence, fee, bodyBytes, signatures, signerInfos) {
    ...
    for (let i = 0; i < multisigPubkey.value.pubkeys.length; i++) {
        ...
        if (signature) {
            ...
            const signerInfo = signerInfos === null || signerInfos === void 0 ? void 0 : signerInfos.get(signerAddress);
            if (signerInfo === null || signerInfo === void 0 ? void 0 : signerInfo.modeInfo) {
                modeInfosList.push(signerInfo.modeInfo);
            }
            else {
                modeInfosList.push({ single: { mode: signing_1.SignMode.SIGN_MODE_LEGACY_AMINO_JSON } });
            }
        }
    }
    const signerInfo = {
 ...
 */
function makeMultisignedTxBytes(multisigPubkey, sequence, fee, bodyBytes, signatures, signerInfos) {
