...
export class StargateClient {
  private readonly tmClient: undefined;
  private readonly queryClient: undefined;
  ...
  // protected getTmClient(): undefined {
  //   return this.tmClient;
  // }

  // protected forceGetTmClient(): any {
  //   if (!this.tmClient) {
  //     throw new Error(
  ...
  // protected getQueryClient(): undefined {
  //   // | (QueryClient & AuthExtension & BankExtension & StakingExtension & TxExtension)
  //   // | undefined {
